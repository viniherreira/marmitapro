...
-- Aqui são 12157 palavras no total, e a duração de cada aula é calculada
-- a partir do próprio texto (81 minutos somados).
--
...
update public.lessons set
  ...
  resumo = 'Antes de cozinhar, entender que negócio é esse e o que ele exige de você.',
  duracao_minutos = 3,
...
where slug = 'o-que-voce-esta-montando';
...
where slug = 'quanto-da-para-faturar';

update public.lessons set
  titulo = 'Estruturando a cozinha que você já tem',
  resumo = 'O que comprar agora, o que comprar depois e o que não comprar nunca.',
  duracao_minutos = 3,
...
where slug = 'estruturando-a-cozinha';

update public.lessons set
  titulo = 'Higiene e boas práticas que não são negociáveis',
  resumo = 'O que a vigilância cobra e, mais importante, o que evita você intoxicar um cliente.',
  duracao_minutos = 3,
...
where slug = 'higiene-e-boas-praticas';
...
where slug = 'formalizacao-mei';

update public.lessons set
  titulo = 'Definindo o seu cardápio de largada',
  resumo = 'Poucos pratos, escolhidos por critério de produção, não por gosto pessoal.',
  duracao_minutos = 3,
...
where slug = 'cardapio-de-largada';

update public.lessons set
  titulo = 'Custo direto: o que entra na marmita',
  resumo = 'Pesar, converter e descobrir o custo real do que vai dentro da embalagem.',
  duracao_minutos = 3,
...
where slug = 'custo-indireto';

update public.lessons set
  titulo = 'O erro que quebra: não pagar a sua própria hora',
  resumo = 'Por que ignorar o seu trabalho faz o negócio parecer lucrativo quando não é.',
  duracao_minutos = 3,
...
where slug = 'margem-e-markup';

update public.lessons set
  titulo = 'Preço psicológico e faixas de mercado',
  resumo = 'Onde o seu preço se encaixa na cabeça do cliente e como pesquisar a sua região.',
  duracao_minutos = 3,
...
where slug = 'preco-psicologico';

update public.lessons set
  titulo = 'Montando a sua tabela de preços',
  resumo = 'Transformar os cálculos em uma tabela que você usa e revisa sem refazer tudo.',
  duracao_minutos = 3,
...
where slug = 'tabela-de-precos';

update public.lessons set
  titulo = 'Quem é o seu cliente num raio de 3 km',
  resumo = 'Por que o seu mercado é geográfico antes de ser demográfico, e como mapear o seu.',
  duracao_minutos = 3,
...
where slug = 'cliente-em-3km';

update public.lessons set
  titulo = 'WhatsApp como vitrine e caixa',
  resumo = 'Organizar pedido, catálogo e cobrança sem sistema, sem planilha e sem perder venda.',
  duracao_minutos = 3,
...
where slug = 'whatsapp-vitrine-e-caixa';

update public.lessons set
  titulo = 'Cardápio que vende sozinho',
  resumo = 'Como descrever um prato para a pessoa bater o olho e pedir, sem você precisar explicar.',
  duracao_minutos = 3,
...
where slug = 'cardapio-que-vende';

update public.lessons set
  titulo = 'Foto de comida com celular',
  resumo = 'A diferença entre a foto que vende e a que afasta está na luz, não no aparelho.',
  duracao_minutos = 3,
...
where slug = 'foto-de-comida-com-celular';

update public.lessons set
  titulo = 'Parcerias com academias e escritórios',
  resumo = 'Como chegar em quem já reuniu o seu cliente, sem parecer vendedor incômodo.',
  duracao_minutos = 3,
...
where slug = 'parcerias-locais';

update public.lessons set
  titulo = 'Produção em lote: cozinhar uma vez, vender a semana',
  resumo = 'O método que transforma seis horas de cozinha em quarenta marmitas sem caos.',
  duracao_minutos = 3,
...
where slug = 'producao-em-lote';

update public.lessons set
  titulo = 'Resfriamento, embalagem e validade',
  resumo = 'Quanto tempo a sua marmita realmente dura, e o que define esse prazo.',
  duracao_minutos = 3,
...
where slug = 'resfriamento-e-validade';

update public.lessons set
  titulo = 'Rota de entrega e taxa que não come o lucro',
  resumo = 'Quanto custa cada entrega de verdade e como organizar para o frete não zerar a margem.',
  duracao_minutos = 3,
...
where slug = 'rota-e-taxa-de-entrega';

update public.lessons set
  titulo = 'Entrega própria, aplicativo ou retirada',
  resumo = 'As três formas de fazer a marmita chegar, com a conta de cada uma.',
  duracao_minutos = 3,
...
where slug = 'entrega-propria-ou-app';

update public.lessons set
  titulo = 'Controle de estoque sem sistema caro',
  resumo = 'Saber o que tem, o que falta e o que está parado, com um caderno e uma regra.',
  duracao_minutos = 3,
...
where slug = 'controle-de-estoque';

update public.lessons set
  titulo = 'O primeiro contato define a recompra',
  resumo = 'Os primeiros minutos de conversa valem mais que qualquer estratégia de venda.',
  duracao_minutos = 3,
...
where slug = 'primeiro-contato';

update public.lessons set
  titulo = 'Plano semanal: a assinatura da marmita',
  resumo = 'Como transformar venda avulsa em receita previsível, sem sistema de assinatura.',
  duracao_minutos = 3,
...
where slug = 'plano-semanal';

update public.lessons set
  titulo = 'Como pedir e usar feedback',
  resumo = 'Perguntar do jeito certo e transformar resposta em decisão de cardápio.',
  duracao_minutos = 3,
...
where slug = 'usando-feedback';

update public.lessons set
  titulo = 'Resolvendo reclamação sem perder margem',
  resumo = 'O roteiro para transformar problema em fidelidade, sem virar refém.',
  duracao_minutos = 3,
...
where slug = 'reclamacao-sem-perder-margem';

update public.lessons set
  titulo = 'Programa de indicação que funciona no bairro',
  resumo = 'Como fazer o cliente satisfeito trazer o próximo, sem gastar com anúncio.',
  duracao_minutos = 3,
...
where slug = 'programa-de-indicacao';
